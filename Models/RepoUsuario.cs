...
namespace InmobiliariaGrosso.Models
{
    public class RepoUsuario 
    {
		...
		public int Alta(Usuario e)
		{
			...
			{
				string sql = $"INSERT INTO Usuarios (Nombre, Apellido, AvatarUrl, Email, Clave, Rol) " +
		...
		public int Modificacion(Usuario e)
		{
			...
			using (MySqlConnection connection = new MySqlConnection(connectionString))
			{
				string sql = $"UPDATE Usuarios SET Nombre=@nombre, Apellido=@apellido, AvatarUrl=@avatar, Email=@email, Clave=@clave, Rol=@rol " +
					$"WHERE Id = @id";
				using (MySqlCommand command = new MySqlCommand(sql, connection))
				{
					command.Parameters.AddWithValue("@nombre", e.Nombre);
		...
		public Usuario ObtenerPorId(int id)
		{
			...
			using (MySqlConnection connection = new MySqlConnection(connectionString))
			{
				string sql = $"SELECT Id, Nombre, Apellido, AvatarUrl, Email, Clave, Rol FROM Usuarios" +
					$" WHERE Id=@id";
